...
sys.path.append('/Neural-Network-Materials')
...
class NanoslabSiCachedEnvLarge(gym.Env):
    def __init__(self, render_mode=None, n_range=(13, 19), a_range=(0.9, 1.035), rc=12.5, n_dos=200):
        self.rc = rc
        self.n_dos = n_dos
