...
__all__ = ["HDNNException", "SymmetryFunctions", "BehlerSFBlock", "StandardizeSF", "BondNeuralNetwork"]
...
class BondNeuralNetwork(nn.Module):
    ...
    def __init__(
        ...
        super(BondNeuralNetwork, self).__init__()
        self.mlp = snn.blocks.MLP(n_in = n_in, n_out = n_out, n_layers = n_layers, activation = activation)
    ...
    def forward(self, inputs):
        ...
        x_ij = self.mlp(rvec_ij * r_ij[:, :, :, None])
